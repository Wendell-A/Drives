...
class Config:
    ...
    PRODUTOS_BIO: List[str] = ["Gasolina A", "Gasolina C","Diesel A S10", "Diesel A S500","Diesel B S10", "Diesel B S500", "MGO"]
    
    # --- LISTA DE PRODUTOS PARA FILTRO DE EXCEÇÃO (NOVOS) ---
    PRODUTOS_FILTRO_EXCECAO: List[str] = ["Gasolina A", "Gasolina C","Diesel A S10", "Diesel A S500","Diesel B S10", "Diesel B S500", "MGO"]
